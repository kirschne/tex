...
Despite heavy research on optimisations mitigating this $path explosion$ problem \todo{cite} only relatively small programs (thousands of lines of code) can be analysed symbolically \todo{cite}.
